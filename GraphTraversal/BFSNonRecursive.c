...
// Non-recursive BFS function
void nonRecursiveBFS(int graph[MAX_NODES][MAX_NODES], int visited[MAX_NODES], Queue *q, int numNodes) {
    while (!isEmpty(q)) {
...
int main() {
    ...
    nonRecursiveBFS(graph, visited, &q, numNodes);
